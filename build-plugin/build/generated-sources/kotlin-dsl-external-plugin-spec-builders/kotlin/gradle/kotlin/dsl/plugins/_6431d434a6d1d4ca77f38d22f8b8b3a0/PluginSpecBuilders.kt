...
package gradle.kotlin.dsl.plugins._6431d434a6d1d4ca77f38d22f8b8b3a0
...
/**
 * The `binary-compatibility-validator` plugin implemented by [kotlinx.validation.BinaryCompatibilityValidatorPlugin].
 */
internal
val `PluginDependenciesSpec`.`binary-compatibility-validator`: PluginDependencySpec
    get() = this.id("binary-compatibility-validator")
...
/**
 * The `org.jetbrains.kotlinx.binary-compatibility-validator` plugin implemented by [kotlinx.validation.BinaryCompatibilityValidatorPlugin].
 */
internal
val `OrgJetbrainsKotlinxPluginGroup`.`binary-compatibility-validator`: PluginDependencySpec
    get() = plugins.id("org.jetbrains.kotlinx.binary-compatibility-validator")
